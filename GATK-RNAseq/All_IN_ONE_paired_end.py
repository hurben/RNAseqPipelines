...
def first_pass_genome_alignment(star_package, ref_seq_dir, file_with_dir, file2_with_dir, prefix_dir):
	cmd = str(star_package) +' --runThreadN 8 --genomeDir ' + str(ref_seq_dir) + ' --readFilesIn ' +str(file_with_dir) + ' ' + str(file2_with_dir) + ' --outFileNamePrefix ' +str(prefix_dir)
...
def second_pass_genome_alignment(star_package, second_prefix_dir, file_with_dir, file2_with_dir):
	cmd = str(star_package) +' --runThreadN 8 --genomeDir ' + str(second_prefix_dir) + ' --readFilesIn ' +str(file_with_dir) + ' ' + str(file2_with_dir) + ' --outFileNamePrefix ' +str(second_prefix_dir)
...
########1st folder buffer
		...
		#RUN : genome align
		first_pass_genome_alignment(star_package, ref_seq_dir, file_with_dir, file2_with_dir, prefix_dir)
...
########2nd folder buffer
		...
		#RUN : genome align
		second_pass_genome_alignment(star_package, second_prefix_dir, file_with_dir, file2_with_dir)
