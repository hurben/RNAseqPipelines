...
for i in range(len(seq_list_readlines)):
	...
	cmd = str(star_file) +' --runThreadN 8 --genomeDir ' + str(genome_dir) + ' --readFilesIn ' +str(file_with_dir) + ' ' + str(file2_with_dir) +' --outFileNamePrefix ./' +str(out_name)
